...
A full-stack web application for managing recruitment processes with access control for students, recruiters, and administrators.


BACKEND API- (https://ocs-backend-3gnr78h4o-aadi-bansals-projects.vercel.app)
FRONTEND API - (https://ocs-frontend-ra70e1hp3-aadi-bansals-projects.vercel.app)

Created an entire server-client based REST API that could be used for acessing data that is linked to different roles.
The files used for the creation of the API are in the repository
...
4) The Browser Client must not transfer raw_password to the serve
